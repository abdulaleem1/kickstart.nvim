...
--custom key bindings
--npm commands
vim.keymap.set('n', '<leader>nrs', '<cmd>tabnew<CR>|<cmd>terminal npm run start<CR>', { desc = '[n]pm [r]un [s]tart' })
vim.keymap.set('n', '<leader>nrb', '<cmd>tabnew<CR>|<cmd>terminal npm run build<CR>', { desc = '[n]pm [r]un [b]uild' })
vim.keymap.set('n', '<leader>ni', '<cmd>tabnew<CR>|<cmd>terminal npm install<CR>', { desc = '[n]pm [i]nstall' })
vim.keymap.set('n', '<leader>nrd', '<cmd>tabnew<CR>|<cmd>terminal npm run dev<CR>', { desc = '[n]pm [r]un [d]ev' })
